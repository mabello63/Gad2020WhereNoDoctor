...
public class CareForSickActivity extends AppCompatActivity {


    RecyclerView recyclerView;
    RecyclerView.LayoutManager layoutManager;
    CareForSickSearchAdapter adapter;
   DBCaringAssetHelper database;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView( R.layout.activity_care_for_sick);
...
//         adapter = new CareForSickSearchAdapter(  this, database.getCaringDetailsByDescription( text ) );
        adapter = new CareForSickSearchAdapter(  this, database.getCareDeails( text ) );
